...
function generateName(){
	...
	var name3 = ["Ideal for a ", "Guild of Dagger and ", "Arrow and ", "Fang and ", "Sword and", "Fellowship of Blessed ", "Thorns of ", "Arrows of ", "Guild of ", "Shields of ", "Fellowship of ", "Circle of ", "Covenant of ", "Rangers of ", "Council of ", "Knights of ", "Hounds of ", "Eldritch", "Crimson ", "Earthquake ", "Legostevens ", "Jimenezlotus ", "Hernandehat ", "Campbestat ", "Bilders Bagmartin ", "Remlend ", "Iron ", "Emerald ", "Ruby", "Golden ", "White", "Black", "Azure ", "Silver ", "Sori's ", "Johnson's ", "Tera's ", "Andom's ", "Draki's ", "Mara's ", "Bellee's ", "Lokiee's ", "Rathi's ", "Wrichy's", "Miray's ", "Helrose ", "Prispell ", "Gantin ", "Chenixie ",
"Ricemus "
	];
	...
	if (Math.random() < 0.5) name2b = capFirst(name4[getRandomInt(0, name4.length + 1)]);
