...
//      { id: 'generatordeath',  name: 'sounds/generatordeath',        formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 10 },

// correspond to lvl 1 - 7 messages
      { id: 'ancbeware',       name: 'sounds/g1an_beware',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },	// announcer messages
      { id: 'ancsorc',       name: 'sounds/g1an_sorc',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancdeath',       name: 'sounds/g1an_usemag',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
// other single display msgs
      { id: 'anctrs',       	name: 'sounds/g1an_treas',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anckeys',       name: 'sounds/g1an_svkey',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancpots',       name: 'sounds/g1an_svpot',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anctraps',       name: 'sounds/g1an_traps',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancwaldes',      name: 'sounds/g1an_waldes',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
// poss multi-use annc
      { id: 'infosnd',        name: 'sounds/g1_info',              formats: ['mp3', 'ogg'], volume: 0.8, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancfoodsh',       name: 'sounds/g1an_dsf',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancpotsh',       name: 'sounds/g1an_dstp',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancfindex',       name: 'sounds/g1an_fex',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancfooled',       name: 'sounds/g1an_fooled',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anchidpot',       name: 'sounds/g1an_hidden',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10  },
      { id: 'anckilthf',      name: 'sounds/g1an_kilthf',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancthislvl',      name: 'sounds/g1an_thislvl',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anctryfind',      name: 'sounds/g1an_tryfind',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
// taunts
      { id: 'ancletsee',      name: 'sounds/g1an_letsee',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancgcoop',      name: 'sounds/g1an_gcoop',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancghero',      name: 'sounds/g1an_heroic',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancivnot',      name: 'sounds/g1an_ivenot',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancssfood',      name: 'sounds/g1an_ssfood',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancfrnds',      name: 'sounds/g1an_frnds',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancdsyf',      name: 'sounds/g1an_dsyf',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancyssop',      name: 'sounds/g1an_yssop',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancyshop',      name: 'sounds/g1an_yshop',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancploff',      name: 'sounds/g1an_ploff',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancyjsp',      name: 'sounds/g1an_yjsp',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anceyf',      name: 'sounds/g1an_eyf',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancstf',      name: 'sounds/g1an_stf',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },		// 		- delay so char precedes
      { id: 'ancstp',      name: 'sounds/g1an_stp',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },		// 		- delay so char precedes
      { id: 'anchasetn',      name: 'sounds/g1an_hasetn',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },		// 		- delay so char precedes

// treasure room annc
      { id: 'ancftreas',      name: 'sounds/g1an_ftreas',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancwtreas',      name: 'sounds/g1an_wtreas',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anc0',      name: 'sounds/g1an_0',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anc1',      name: 'sounds/g1an_1',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anc2',      name: 'sounds/g1an_2',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anc3',      name: 'sounds/g1an_3',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anc4',      name: 'sounds/g1an_4',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anc5',      name: 'sounds/g1an_5',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anc6',      name: 'sounds/g1an_6',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anc7',      name: 'sounds/g1an_7',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anc8',      name: 'sounds/g1an_8',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anc9',      name: 'sounds/g1an_9',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anc10',      name: 'sounds/g1an_10',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
...
// troom taunts
      { id: 'ancbetr',      name: 'sounds/g1an_better',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancymi',      name: 'sounds/g1an_cymi',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anchurry',      name: 'sounds/g1an_hurry',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anckid',      name: 'sounds/g1an_kidding',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anctimes',      name: 'sounds/g1an_times',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anctoms',      name: 'sounds/g1an_toms',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anculoose',      name: 'sounds/g1an_uloose',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },

// multi part annc - these are combined into a single msg...which might need to be recorded seperately
// char positive annc
      { id: 'ancwar1',      name: 'sounds/g1an_war0',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancelf1',      name: 'sounds/g1an_elf1',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancwiz1',      name: 'sounds/g1an_wiz1',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancval1',      name: 'sounds/g1an_valk1',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
// char abt to die - xclude warrior, he only has 1
      { id: 'ancwiz2',      name: 'sounds/g1an_wiz2',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancval2',      name: 'sounds/g1an_val2',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancelf2',      name: 'sounds/g1an_elf2',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
// 3rd wiz, not sure
      { id: 'ancwiz3',      	name: 'sounds/g1an_wiz3',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
// powers		- delay so "{char} now has" precedes
      { id: 'ancxspd',    	  name: 'sounds/g1an_xspd',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancxshtpwr',      name: 'sounds/g1an_shtpwr',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancxshtspd',      name: 'sounds/g1an_shtspd',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancxarm',      name: 'sounds/g1an_xarm',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancxft',    		  name: 'sounds/g1an_xft',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancxmag',      name: 'sounds/g1an_xmag',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancinvis',      name: 'sounds/g1an_invis',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
// bld dialog
      { id: 'ancnhs',      name: 'sounds/g1an_nowhas',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },		// 		- delay so char precedes - "elf now has"
      { id: 'ancwelc',      name: 'sounds/g1an_welcome',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
// nearing death		- delay so char precedes
      { id: 'ancpwrl',      name: 'sounds/g1an_pwrlost',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancruno',      name: 'sounds/g1an_runout',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'ancndsfd',      name: 'sounds/g1an_needsfood',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'anc2die',      name: 'sounds/g1an_abt2die',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },

// shots
      { id: 'firewarrior',     name: 'sounds/g1fire_war',           formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 }, //   NOTE: ie has limit of 40 <audio> so be careful with pool amounts
      { id: 'firevalkyrie',    name: 'sounds/g1fire_val',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'firewizard',      name: 'sounds/g1fire_wiz',            formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'fireelf',         		name: 'sounds/g1fire_elf',               formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'potionbang',  	name: 'sounds/g1_potionboom',        formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
// aches / pains
      { id: 'warriorpain1',    name: 'sounds/g1pain_war1',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'warriorpain2',    name: 'sounds/g1pain_war2',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'warriorpain3',    name: 'sounds/g1pain_war3',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'warriorpain4',    name: 'sounds/g1pain_war4',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'warriorpain5',    name: 'sounds/g1pain_war5',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'warriorpain6',    name: 'sounds/g1pain_war6',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'warriorpain7',    name: 'sounds/g1pain_war7',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'warriorpain8',    name: 'sounds/g1pain_war8',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'warriorpain9',    name: 'sounds/g1pain_war9',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'wizardpain1',    name: 'sounds/g1pain_wiz1',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'wizardpain2',    name: 'sounds/g1pain_wiz2',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'wizardpain3',    name: 'sounds/g1pain_wiz3',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'wizardpain4',    name: 'sounds/g1pain_wiz4',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'wizardpain5',    name: 'sounds/g1pain_wiz5',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'wizardpain6',    name: 'sounds/g1pain_wiz6',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'wizardpain7',    name: 'sounds/g1pain_wiz7',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'wizardpain8',    name: 'sounds/g1pain_wiz8',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'wizardpain9',    name: 'sounds/g1pain_wiz9',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'elfpain1',    name: 'sounds/g1pain_elf1',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'elfpain2',    name: 'sounds/g1pain_elf2',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'elfpain3',    name: 'sounds/g1pain_elf3',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'elfpain4',    name: 'sounds/g1pain_elf4',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'elfpain5',    name: 'sounds/g1pain_elf5',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'elfpain6',    name: 'sounds/g1pain_elf6',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'elfpain7',    name: 'sounds/g1pain_elf7',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'elfpain8',    name: 'sounds/g1pain_elf8',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'elfpain9',    name: 'sounds/g1pain_elf9',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'valkyriepain1',    name: 'sounds/g1pain_val1',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'valkyriepain2',    name: 'sounds/g1pain_val2',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'valkyriepain3',    name: 'sounds/g1pain_val3',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'valkyriepain4',    name: 'sounds/g1pain_val4',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'valkyriepain5',    name: 'sounds/g1pain_val5',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'valkyriepain6',    name: 'sounds/g1pain_val6',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'valkyriepain7',    name: 'sounds/g1pain_val7',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'valkyriepain8',    name: 'sounds/g1pain_val8',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'valkyriepain9',    name: 'sounds/g1pain_val9',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
// hurts - nominally more serious pain			- as yet unused
/*
      { id: 'wizardhurt',    name: 'sounds/g1hurt_wiz',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'elfhurt',    name: 'sounds/g1hurt_elf',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'valkyriehurt',    name: 'sounds/g1hurt_val',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'valkyriehurt2',    name: 'sounds/g1hurt_val2',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'warriorhurt',    name: 'sounds/g1hurt_war',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
*/
// died
      { id: 'wizarddie1',    name: 'sounds/g1die_wiz1',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'wizarddie2',    name: 'sounds/g1die_wiz2',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'elfdie1',    name: 'sounds/g1die_elf1',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'elfdie2',    name: 'sounds/g1die_elf2',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'valkyriedie1',    name: 'sounds/g1die_val1',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'valkyriedie2',    name: 'sounds/g1die_val2',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'warriordie1',    name: 'sounds/g1die_war1',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'warriordie2',    name: 'sounds/g1die_war2',          formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },

// std sound fx group
      { id: 'exitlevel',       name: 'sounds/g1_exit',             formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'collectgold',     name: 'sounds/g1_treaspick',           formats: ['mp3', 'ogg'], volume: 0.5, pool: ua.is.ie ? 2 : 10 },
      { id: 'collectpotion',   name: 'sounds/g1_potionpick',         formats: ['mp3', 'ogg'], volume: 0.5, pool: ua.is.ie ? 2 : 10 },
      { id: 'collectkey',      name: 'sounds/g1_key',            formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'collectfood',     name: 'sounds/g1_foodsnrf',           formats: ['mp3', 'ogg'], volume: 1.0, pool: ua.is.ie ? 2 : 10 },
      { id: 'opendoor',        name: 'sounds/g1_door',              formats: ['mp3', 'ogg'], volume: 0.8, pool: ua.is.ie ? 2 : 10 },
      { id: 'teleport',        	name: 'sounds/g1_teleport',              formats: ['mp3', 'ogg'], volume: 0.8, pool: ua.is.ie ? 2 : 10 },
      { id: 'trap',        			name: 'sounds/g1_wallexit',              formats: ['mp3', 'ogg'], volume: 0.8, pool: ua.is.ie ? 2 : 10 },
      { id: 'stun',      		  name: 'sounds/g1_stun',              formats: ['mp3', 'ogg'], volume: 0.8, pool: ua.is.ie ? 2 : 10 },
      { id: 'wallexit',        name: 'sounds/g1_wallexit',              formats: ['mp3', 'ogg'], volume: 0.8, pool: ua.is.ie ? 2 : 10 },
      { id: 'dtouch',        name: 'sounds/g1_deathtouch',              formats: ['mp3', 'ogg'], volume: 0.8, pool: ua.is.ie ? 2 : 10 },
      { id: 'healthcnt',      name: 'sounds/g1_healthcount',              formats: ['mp3', 'ogg'], volume: 0.8, pool: ua.is.ie ? 2 : 10 },
      { id: 'sbuzz',      		  name: 'sounds/g1_buzz',              formats: ['mp3', 'ogg'], volume: 0.8, pool: ua.is.ie ? 2 : 10 },
