...
/// RESTORE to 30
      ...
      FLOOR = { 	BROWN_BOARDS: 1, LIGHBROWN_BOARDS: 2, GREEN_BOARDS: 3, GREY_BOARDS: 4, WOOD: 5, LIGHT_STONE: 6, DARK_STONE: 7, BROWN_LAMINATE: 8, 
									PURPLE_LAMINATE: 9, 
									MIN: 1, MAX: 9 },
      WALL  = { 	INVIS: 1, BLUE: 2, BLUE_BRICK: 3, PURPLE_TILE: 4, BLUE_COBBLE: 5, PURPLE_COBBLE: 6, CONCRETE: 7, PINKSLD: 8, BROWN: 9, GREEN: 10, RED: 11, 
									MIN: 1, MAX: 11 },
      EVENT = {
        START_LEVEL:         0,
        PLAYER_JOIN:         1,
...
//      { id: 'gtitle',      name: 'sounds/music.title',      formats: ['mp3', 'ogg'], volume: 1.0, loop: false             },
    ...
    levels: [
      ...
      { name: 'Level 1',       url: "levels/glevel1.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.PINKSLD,      music: 'bloodyhalo',      score:  1000, help: "Welcome" },
      ...
      { name: 'Research 1',     url: "levels/glevel1r.png",  floor: FLOOR.PURPLE_LAMINATE,      wall: WALL.RED,      music: 'mountingassault',      score:  1000, help: null },
      ...
      { name: 'Level 68',     url: "levels/glevel68.png",  floor: FLOOR.BROWN_LAMINATE,      wall: WALL.PINKSLD,      music: 'mountingassault',      score:  1000, help: null },
      ...
      for(ty = 0, th = map.th ; ty < th ; ty++) {
        for(tx = 0, tw = map.tw ; tx < tw ; tx++) {
          ...
          if (is.valid(cell.wall))
			  {
				  if (map.level.wall != WALL.INVIS)		// dont tile for invis walls
